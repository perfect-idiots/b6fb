  ...
  public function render(): Component {
    ...
    return new AdminDeleteConfirmBox(
      $this->assign([
        ...
        'title' => 'Xóa thể loại',
        'warning' => "Thao tác sau đây sẽ xóa thể loại “{$genreName}”. Hành động này **không thể hoàn tác**.",
  ...
  public function render(): Component {
    ...
    return new AdminDeleteConfirmBox(
      $this->assign([
        ...
        'title' => 'Xóa trò chơi',
        'warning' => "Thao tác sau đây sẽ xóa trò chơi “{$gameName}”. Hành động này **không thể hoàn tác**.",
        'question' => HtmlElement::emmetTop('.question', [
